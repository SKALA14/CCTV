...
class Settings(BaseSettings):
    ...
    GENERAL_OPTICAL_FLOW_ENABLED: bool = True
    GENERAL_OPTICAL_FLOW_RESIZE_WIDTH: int = 320
    GENERAL_OPTICAL_FLOW_THRESHOLD: float = 2.5
    GENERAL_OPTICAL_FLOW_PERCENTILE: float = 95.0
    GENERAL_OPTICAL_FLOW_STATE_TTL_SEC: float = 600.0
